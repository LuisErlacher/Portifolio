      ...
      <figure>
        ...
        <blockquote className="mb-6">
          <p className="text-2xl text-gray-900">
            Precisei de uma auteração visual em meu site e o Luis resolveu muito rapido e me entregou o projeto no prazo e executando corretamente
        ...
        <figcaption className="flex items-center justify-center gap-2">
          ...
          <div className="flex items-center divide-x-2 divide-gray-200">
            <div className="pr-3 font-medium text-gray-900">Carlos Henrique</div>
